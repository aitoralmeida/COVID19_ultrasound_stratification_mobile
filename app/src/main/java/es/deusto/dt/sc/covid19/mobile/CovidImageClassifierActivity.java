...
public class CovidImageClassifierActivity extends AppCompatActivity {
    ...
    private static final String MODEL_NAME = "covid19_model_efficientnetB1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInput = ByteBuffer.allocateDirect(IMAGE_WIDTH * IMAGE_HEIGHT * CHANNELS * 4).order(ByteOrder.nativeOrder());
        ...
        int bufferSize = CLASSES * java.lang.Float.SIZE / java.lang.Byte.SIZE;
